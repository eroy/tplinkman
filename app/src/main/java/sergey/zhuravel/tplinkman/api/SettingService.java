...
public interface SettingService {
    ...
    Observable<Response<ResponseBody>> setLogout(@Header(GetValueConst.COOKIE) String cookie,
                                                 @Header(GetValueConst.REFERER) String referer);

    @GET(ApiConstant.REBOOT)
    Observable<Response<ResponseBody>> setReboot(@Header(GetValueConst.COOKIE) String cookie,
                                                 @Header(GetValueConst.REFERER) String referer);

    @GET(ApiConstant.WIFI_MODE_SETTING)
    Observable<Response<ResponseBody>> setWifiMode(@Header(GetValueConst.COOKIE) String cookie,
                                                   @Header(GetValueConst.REFERER) String referer,
                                                   @Query(GetValueConst.AP) String ap);


    @GET(ApiConstant.WAN_DYNAMIC)
    Observable<Response<ResponseBody>> setWanDynamic(@Header(GetValueConst.COOKIE) String cookie,
                                                     @Header(GetValueConst.REFERER) String referer);


    @GET(ApiConstant.WAN_STATIC)
    Observable<Response<ResponseBody>> setWanStatic(@Header(GetValueConst.COOKIE) String cookie,
                                                    @Header(GetValueConst.REFERER) String referer,
    ...
    Observable<Response<ResponseBody>> setWanPptp(@Header(GetValueConst.COOKIE) String cookie,
                                                  @Header(GetValueConst.REFERER) String referer,
    ...
    Observable<Response<ResponseBody>> setWanPppoe(@Header(GetValueConst.COOKIE) String cookie,
                                                   @Header(GetValueConst.REFERER) String referer,
